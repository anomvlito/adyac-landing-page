...
5. Crea un commit descriptivo y sube a `main`:
...
- Para cambios de Vercel, revisa primero la configuración existente (`.vercel/`, `vercel.json` y scripts) y modifica sólo lo pedido.
