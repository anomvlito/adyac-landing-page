# Anexo A — Alcance, hitos, aceptación y soporte

**Cotización:** ADYAC-COT-CICUC-2026-001  
**Versión:** 1.0 — 31 de julio de 2026  
**Estado:** Borrador sujeto a revisión y firma
...
|---|---|---|
| Mes 1 — Descubrimiento | Línea base, arquitectura, modelo conceptual, permisos provisionales, prototipo y ambiente demo | Aprobación escrita de línea base y entrega |
...
1. Adyac notificará la entrega y acompañará evidencia.
2. CICUC tendrá 5 días hábiles para revisar contra criterios acordados.
3. La aceptación deberá constar por escrito; el silencio no constituye aceptación.
4. El rechazo identificará criterios incumplidos y evidencia reproducible.
5. Adyac corregirá sin costo defectos atribuibles al alcance y volverá a presentar.
6. Requisitos nuevos seguirán control de cambios.

## 5. Dependencias de CICUC

CICUC designará una contraparte, entregará decisiones oportunamente, proporcionará
solo datos sintéticos o autorizados y validará roles, privacidad, custodia,
infraestructura y KPI. Los retrasos atribuibles a estas dependencias ajustarán el
calendario de común acuerdo y por escrito.
...
Cualquiera de las partes podrá terminar por incumplimiento material no subsanado
dentro de 10 días hábiles desde notificación. CICUC pagará entregables aceptados;
Adyac entregará artefactos pagados y cooperará razonablemente con la transición.

Cada parte responderá por daños directos acreditados que le sean imputables. Se
propone como límite general el monto neto pagado o pagadero, salvo dolo, culpa
grave u obligaciones irrenunciables. Confidencialidad, datos personales e
infracción de propiedad intelectual deben acordarse en el contrato definitivo.

## 8. Facultad

La aceptación solo será válida por personas con facultades suficientes. Toda
orden de compra deberá identificar la cotización y los Anexos A, B y C, con
versión y fecha.

**Referencia:** Código Civil de Chile, especialmente artículos 1545 y 1546:
